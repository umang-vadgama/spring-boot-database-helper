...
public class Service {
    ...
    public void insertIntoStudentEnrollUsingJPA(){
        ...
        addStudent.add(new StudentEnroll("Raj","Sharma","1234567899", Date.valueOf("1998-03-31"),computerEngg));

        addStudent.add(new StudentEnroll("Keyur","Sharma","45454545544",Date.valueOf("1999-05-28"),computerEngg));
